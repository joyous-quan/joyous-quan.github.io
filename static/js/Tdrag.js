/*! Tdrag 0.0.1 */
/** 示例： https://www.jq22.com/yanshi8362
            ...
            move: function (ev, obj) {
               ...
               /* if(self.options.changeWhen=="move") {
                ...
                if(self.options.handle!=null){
                    ...
                    $(obj).find(self.options.handle).unbind("ontouchmove");
                    $(obj).find(self.options.handle).unbind("onmouseup");
                    $(obj).find(self.options.handle).unbind("ontouchend");
                }else{
                    $(obj).unbind("onmousemove");
                    $(obj).unbind("ontouchmove");
                    $(obj).unbind("onmouseup");
                    $(obj).unbind("ontouchend");
                }
