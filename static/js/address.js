function _addAddressBox(title,type,funcname,obj) {
    ...
    var addAddress = '<div class="mask add-addr-mask"><div class="mask_bg"></div>' +
        '<div class="popups add-addr-popups form-popups logout-inquire-mask"  style="height: 670px;">' +
        '<h2 class="form-popups-title">'+title+'</h2>' +
        '<span class="del-mask"><i class="iconfont icon-delete1"></i></span>' +
        '<p class="form-popups-tips">' +
        '请使用有效的公司或研究机构地址，订单无法发货至公寓和私人住所。' +
        '</p>' +
        '<div class="form-box add-addr-form">' +
        '<p><span>*</span> 省：</p>' +
        '<select id="addBox_province" onchange="_uptProvince(this)">' +provinces+
        '</select>' +
        '<p><span>*</span> 市：</p>' +
