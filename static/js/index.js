...
function _openBox(title,html,w,h){
    ...
    <div class="popups form-popups" style="width: '+w+'px;height: '+h+'px;">\
        ...
        <span class="del-mask"><i class="iconfont icon-delete" style="font-size:26px;" onclick="$(this).parents(\'.common_mask\').hide()"></i></span>\
...
function _openLoginBox(){
    //if(isempty(getCookie("access_token"))) {
        ...
        <div class="popups form-popups log-inquire-popups" style="width:480px;height:360px;">\
            <h2 class="form-popups-title">会员登录</h2>\
            <span class="del-mask"><i class="iconfont icon-delete" style="font-size:26px;" onclick="_close(this)"></i></span>\
